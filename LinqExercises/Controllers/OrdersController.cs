...
namespace LinqExercises.Controllers
{
    public class OrdersController : ApiController
    {
        ...
        {
            //("return orders with dates between the given start date and the given end date with freight under 100 units.");
            //
            var dateSearchUnder100Units = _db.Orders.Where(o => o.RequiredDate >= startDate && o.RequiredDate <= endDate && o.Freight < 100);

            return Ok(dateSearchUnder100Units);
        ...
        public IHttpActionResult PurchaseReport()
        {
            ...
            var purchases = from o in _db.Products
                          select new
                          {
                              property = o,
                              quantity = o.Order_Details.Sum(p => p.Quantity)        
                          };
